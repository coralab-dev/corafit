...
export function ClientList({
  ...
  return (
    <section className="min-w-0 bg-background px-4 pb-6 sm:px-6 xl:pr-2">
      <div className="rounded-2xl border !border-transparent bg-card p-4 shadow-[var(--surface-shadow)] sm:p-5">
        ...
        <div className="mt-5">
          ...
          {isLoading ? (
              ...
              {clients.map((client) => {
                ...
                return (
                  <article
                    key={client.id}
                    className={cn(
                      "rounded-2xl border !border-transparent bg-background p-4 shadow-[var(--surface-shadow-soft)] transition-[background,box-shadow]",
                      isSelected && "bg-accent/55 shadow-[0_0_0_1px_rgba(217,95,73,0.36),0_12px_28px_rgba(217,95,73,0.08)] dark:shadow-[0_0_0_1px_rgba(230,95,73,0.34)]",
                    )}
                  >
                    <button
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                          <div className="rounded-xl border !border-transparent bg-card p-3 shadow-[var(--surface-shadow-soft)]">
            ...
            <div className="hidden overflow-hidden rounded-2xl border !border-transparent shadow-[var(--surface-shadow-soft)] md:block">
